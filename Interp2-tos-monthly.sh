...
echo "model & var :::::::::::::::::::::" ${model}/"run"${irun}/"::::::::::::::::::::::"

	  ### combine  
   	set fc = $patho/combine.nc
	  set fall = $pathi/${var}_${cmon}_${model}_${sces}_r${irun}i*.nc
	  cdo cat $fall $fc
 
    ### select year
    set fm = $patho/sel.nc
    cdo selyear,1980/1999 $fc $fm
    # cdo selyear,2080/2099 $fc $fm

    ### remap
    set fr = $patho/${var}_${model}_${sces}_run${irun}_1x1_monthly_1980-1999.nc
    # set fr = $patho/${var}_${model}_${sces}_run${irun}_1x1_monthly_2080-2099.nc
